...
export class CardController {
  ...
  @ApiBadRequestResponse({ description: "Raises when card's data is invalid", type: BadRequestExample })
  ...
  @ApiResponse({ status: 200, description: 'Card found', type: CardRespDto })
  @ApiResponse({ status: 204, description: 'No card found', type: undefined })
